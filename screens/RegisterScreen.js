...
function getPasswordStrength(pw) {
  ...
  return pw.length === 0 ? levels[0] : levels[Math.min(score, 5)];
}
...
function InputField({ label, icon, placeholder, value, onChangeText, keyboardType, autoCapitalize }) {
  return (
    <View style={styles.inputGroup}>
...
const styles = StyleSheet.create({
  ...
  formCard: {
    ...
    borderRadius: 24, padding: 24, ...SHADOWS.md,
  },
